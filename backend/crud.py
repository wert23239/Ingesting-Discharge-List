...
def create_record(db: Session, name: str, epic_id: str, phone_number: str, insurance: str):
    print("create record")
    new_record = Record(name=name, epic_id=epic_id, phone_number=phone_number, insurance=insurance, status="non-verified")
    db.add(new_record)
    db.commit()
